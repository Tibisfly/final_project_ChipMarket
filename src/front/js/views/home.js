	...
	return (
		<>
				...
				<div className="row g-0">
					<div id="home-izq" className="col-lg-6 col-md-6 col-12 home-izq">
						<div className="message-content">
							<div className="title">ESTE ES EL TITULO</div>
							<div className="message">
								You need to hook into componentDidMount which is run after render method. There, you get
			...
			<div className="container-fluid p-0 m-0">
				{/* <div className="hero">
					<h1 className="home-title">Ahorra tiempo</h1>
				</div> */}
							...
							<div className="col-lg-8 my-5">
								<div className="card-body ">
									...
									<p className="card-text text-justify fs-2">
										No es secreto que el año 2020 fue duro para todos, pero aún más para personas
										muy cercanas a ti: El comerciante de barrio. Fruterías, ferreterías,
										restaurantes, peluquerías y variedad de comercios se han visto afectados por el
										confinamiento del 2020. Más del 5% de comercios de barrio han cerrado en España
										por motivo al coronavirus.
									</p>
								</div>
							</div>
						</div>
						...
						<div
							...
							<div className="col-lg-7 order-sm-2 order-lg-1">
								<div className="card-body" style={{ marginBotton: "30px" }}>
									...
									<p className="card-text text-justify fs-2">
										¡Con ChipMarket es muy sencillo!. Simplemente introduciendo tu código postal
										puedes obtener las ofertas de los comercios cercanos a ti. Cada publicación
										tiene un código promocional para que aproveches ese descuento de ChipAddicts.
									</p>
								</div>
							</div>
						...
						<div
							...
							<div className="col-lg-8 my-5">
								<div className="card-body" style={{ marginBottom: "3 rem" }}>
									...
									<p className="card-text text-justify fs-2">
										Nuestra comunidad existe como apoyo al emprendedor, la fusión entre la
										tecnología y las tiendas de toda la vida va a aumentar el consumo al comercio de
										barrio. La simbiosis entre ciudadanos darán el progreso a la sociedad.
									</p>
								</div>
							</div>
						</div>
